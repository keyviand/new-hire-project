...
function drawEcho(x,y){ctx.save();ctx.shadowColor='#c27dff';ctx.shadowBlur=18;ctx.fillStyle='#bd7cff';ctx.beginPath();ctx.arc(x,y,14,0,Math.PI*2);ctx.fill();ctx.strokeStyle='#f6eaff';ctx.lineWidth=2;ctx.stroke();ctx.restore();ctx.fillStyle='#ead7ff';ctx.font='11px Segoe UI';ctx.textAlign='center';ctx.fillText('Echo [AI]',x,y-25);}
